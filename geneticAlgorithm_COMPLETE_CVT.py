...
def produceOffspring(population, tournament_number, mutation_chance, mutation_size, min_val, max_val, training_data, rule_mutation_chance, min_rule_number, max_rule_number, test_data):
    # Create an offspring array
    offspring = []
    ...
    updatePopulationFitness(offspring, test_data)
...
def trainAlgorithm(population, iterations, tournament_number, mutation_chance, mutation_size, min_val, max_val, training_data, rule_mutation_chance, min_rule_number, max_rule_number, cross_training_split_number):
    ...
    for a in range(iterations):
        ...
        for segment_number in range(len(data)):
            ...
            population = produceOffspring(population, tournament_number, mutation_chance, mutation_size, min_val, max_val, nCV_training_data, rule_mutation_chance, min_rule_number, max_rule_number, nCV_test_data)
