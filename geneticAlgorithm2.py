...
def produceOffspring(population, tournament_number, mutation_chance):
    # Create an offspring array
    offspring = []
    ...
    for x in range(len(population)):
        ...
        child = mutate(crossover(parent1, parent2), mutation_chance)
...
def findBestIndividual(population):
    ...
    best = population[round(random.random()*len(population))]
    # For every individual in the population
    for individual in population:
...
def geneticSolve(population, iterations, tournament_number, mutation_chance):
    ...
    for a in range(iterations):
        ...
        population = produceOffspring(population, tournament_number, mutation_chance)
...
geneticSolve(population, 50, 2, 0.005)
